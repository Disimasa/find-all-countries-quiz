...
const flagsDir = path.join(root, 'static/flags/eras/ce1279')
const curatedPath = path.join(root, 'scripts/era-mappings/ce1279_flag_curated.json')
const entitiesPath = path.join(root, 'static/data/eras/ce1279/entities.json')

describe('ce1279 era flags manifest', () => {
	...
	it('has full flag coverage', () => {
		...
		expect(coverage.fetched).toBe(60)
	})
